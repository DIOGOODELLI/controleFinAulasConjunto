        ...
        <form class="col s12 indigo lighten-5" name="frmAlterar" method="post">
          <div class="row">
            <div class="input-field col s6">
              <input type="text" class="validate" name="nome" maxlength="100" size="80" value="<%=cidade.getNome()%>" >
              <label>Cidade</label>
            </div>
          </div> 
          <div class="row">    
            <div class="input-field col s6">
              <input type="text" class="validate" name="estado" maxlength="2" size="3" value="<%=cidade.getEst_sigla()%>">
              <label>Estado</label>
            </div>
          </div>
          <div class="row"> 

       ...
       <ul id="dropdown1" class="grey lighten-1 dropdown-content">
        ...
        <nav class="blue darken-4">
            <div class="nav-wrapper">
                <a href="#!" class="brand-logo grey-text text">Nova Pessoa</a>
         ...
         <%
            ...
            if(request.getParameter("btnEnviar") != null){
                ...
                Pessoa pessoa = new Pessoa(codigo, nome, idade, email, cidade);
        ...
        <form class="col s12 indigo lighten-5" name="fmrCidade" method="post">
            ...
            <div class="row">
                <div class="input-field col s6">
                    <input type="number" class="validate" name="codigo">
                  <label>Código</label>
                </div>
            </div>
            ...
            <div class="row">    
              <div class="input-field col s6">
                  <input type="number" class="validate" name="idade" >
                <label>Idade</label>
              </div>
            </div>
          <div class="row">    
          ...
          <div class="row">    
            <div class="input-field col s6">
                <input type="number" class="validate" name="cidade">
              <label>Cidade</label>
            </div>
          </div>
